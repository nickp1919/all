...
export const BUTTON_EXTRA_TYPE: { [key: string]: ExtraType } = {
...
export const BUTTON_PULSE_TYPE: { [key: string]: Type } = {
	secondary: 'secondary',
	tertiary: 'tertiary',
	undefined: undefined,
};
...
export const BUTTON_SIZE: { [key: string]: Size } = {
	s: 's',
	m: 'm',
	l: 'l',
};
...
export const MODAL_SIZE: { [key: string]: SizeModal } = {
	s: 's',
	m: 'm',
	l: 'l',
};
...
export const FORM = {
	...
	FIELD_TOOLTIPS: {
		...
		PASSWORD:
			'The password field must contain minimum 8 characters, at least one uppercase letter, one lowercase letter and one number',
...
export const POPUP_DIRECTION: { [key: string]: string } = {
	TOP: 'top',
	TOP_LEFT: 'topLeft',
	TOP_RIGHT: 'topRight',
	BOTTOM: 'bottom',
...
export const REGEXP_RECIPES = {
	...
	NATURAL_NUMBERS: new RegExp('^$|^[0-9][0-9]*$'), // Натуральные числа - начиная с 0
