...
function twoColStyle(widthBlocks: WidthBlocks) {
  let styles = '';
...
function clearRight(col: number) {
...
function defaultWrapper(options: UIAdaptiveOptions, breakpoints: TBreakpoints, indents: boolean) {
  let styles = '';
  ...
  function widthBlocksStyle(widthBlocks: WidthBlocks) {
    let styles = '';

    widthBlocks.forEach((item: string, i: number) => {
...
function breakpointsWidth(widthBlocks: WidthBlocks, indents: boolean) {
  let styles = '';
  const col = isArrayCount(widthBlocks);
...
function breakpointsWrapper(breakpoints: TBreakpoints, indents: boolean) {
  let styles = '';
