...
export const SelectedPersonLi = styled(BoxBlock) `
  ${css({ mb: 3, px: 2 })}
  ${AlignCenter}
  position: relative;
  ...
  min-height: 27.61px;
`;
export const AddUsersInTitleText = styled(TextBlock) `
  margin-top: 0;
`;
...
export const UserListEmptyInnerDiv = styled(BoxBlock) `
  ...
  width: 51%;
`;
export const UserListEmptyText = styled(TextBlock) `
  ${css({ mt: 4 })}
`;
...
`;
export const AddUsersInSubmitButton = styled(Button) `
  && {
...
`;
export const ChosenPersonsUl = styled(BoxBlock) `
  list-style: none;
  ${Flex}
  ${Wrap}
...
`;
export const AddUsersInPanelText = styled(TextBlock) `
  ${css({ mt: 4 })}
`;
export const DropContentCheckBoxDiv = styled(BoxBlock) `
  ${css({ my: 6 })}
`;
export const SearchWrapperDiv = styled(BoxBlock) `
  ${css({ mt: 4 })}
`;
export const DropContentCardsDiv = styled(BoxBlock) `
  min-height: 500px;
